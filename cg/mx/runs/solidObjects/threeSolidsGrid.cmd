#
#   Three Solid objects in a domain
#
#
# usage: ogen [noplot] threeSolidsGrid -factor=<num> -order=[2/4/6/8] -interp=[e/i] -numGhost=<i>
# 
# examples:
#     ogen -noplot threeSolidsGrid -interp=e -order=2 -factor=4 
#     ogen -noplot threeSolidsGrid -interp=e -order=2 -factor=8
#     ogen -noplot threeSolidsGrid -interp=e -order=4 -factor=4 
#     ogen -noplot threeSolidsGrid -interp=e -order=4 -factor=8
#
$prefix="threeSolidsGrid"; 
$order=2; $factor=1; $interp="i"; # default values
$orderOfAccuracy = "second order"; $ng=2; $interpType = "implicit for all grids";
$name=""; $xa=-1.; $xb=1; $ya=-2.5; $yb=2.5; $ml=0; 
...
include $ENV{CG}/mx/runs/solidObjects/iBeamSolid.h
# 
# ---------------------- IBEAM 1 -------------------------------
...
include $ENV{CG}/mx/runs/solidObjects/buildIBeamGrids.h
# 
# ---------------------- IBEAM 3 ------------------------
$xShift=0; $yShift=-1.5; $angle=90; $xMin=-$radY; $xMax=-$xMin; $yMin=-$radX; $yMax=-$yMin;
include $ENV{CG}/mx/runs/solidObjects/buildIBeamGrids.h
...
$splitRingNames="#"; 
$count=0;
include $ENV{CG}/mx/runs/solidObjects/splitRingSolid.h
#
# ------------------ Split Ring 1 ---------------
$xr=.0; $yr=0; # center for rotation
$xShift=0;  $yShift=0; $angle=0; $xMin=-$radX; $xMax=-$xMin; $yMin=-$radY; $yMax=-$yMin;
include $ENV{CG}/mx/runs/solidObjects/buildSplitRingGrids.h 
#
# ------------------ Split Ring 2 ---------------
$xr=.0; $yr=0; # center for rotation
