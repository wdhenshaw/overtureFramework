...
% ----------------------------------------------------------------------
\section{Installing Overture - general comments}

Here are instructions to install the Overture library. See also the README file that comes with Overture.

To get Overture you should go to \htmladdnormallink{https://sourceforge.net/projects/overtureframework}{https://sourceforge.net/projects/overtureframework}
...
\end{Verbatim}
or if you have an account on sourceForge ypu can use
\begin{Verbatim}
