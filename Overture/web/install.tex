...
\begin{abstract}
{ \color{red} NOTE: This document is out of date -- see the README and install files when you get the overtureFramework from sourceforge}
...
{ \color{red} NOTE: This document is out of date -- see files README and install files when you get the overtureFramework from sourceforge}
...
Note: Mac OS users should skip ahead to Section~\ref{sec:installMac}.
\vskip\baselineskip
...
% \input macInstall2020April6.tex
...
\input ubuntuInstall2020April6.tex
