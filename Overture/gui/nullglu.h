...
inline GLint gluBuild1DMipmapLevels (GLenum target, ... ){ return 0; };
inline GLint gluBuild1DMipmaps (GLenum target, ... ){ return 0; };
inline GLint gluBuild2DMipmapLevels (GLenum target, ... ){ return 0; };
inline GLint gluBuild2DMipmaps (GLenum target, ... ){ return 0; };
inline GLint gluBuild3DMipmapLevels (GLenum target, ... ){ return 0; };
inline GLint gluBuild3DMipmaps (GLenum target, ... ){ return 0; };
inline GLboolean gluCheckExtension (const GLubyte *extName, ... ){ return false; };
...
inline const GLubyte * gluErrorString (GLenum error){ return NULL; };
inline void gluGetNurbsProperty (GLUnurbs* nurb, ... ){};
inline const GLubyte * gluGetString (GLenum name){ return NULL; };
...
inline GLUnurbs* gluNewNurbsRenderer (void){ return NULL; };
inline GLUquadric* gluNewQuadric (void){ return NULL; };
inline GLUtesselator* gluNewTess (void){ return NULL; };
...
inline GLint gluProject (GLdouble objX, ... ){ return 0; };
...
inline GLint gluScaleImage (GLenum format, ... ){ return 0; };
...
inline GLint gluUnProject (GLdouble winX, ... ){ return 0; };
inline GLint gluUnProject4 (GLdouble winX, ... ){ return 0; };
